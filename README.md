О самоорганизации написано очень много. Со временем я заметил, что чужие системы в чистом виде у меня не приживаются. Поэтому постепенно из разных идей и собственного опыта у меня сложилась своя. В статье покажу, на чем она основана и как реализована на практике в TickTick.
...
<img src="imgs/single-calendar.png" width="1000">
...
<img src="imgs/ticktick-calendar-home.png" width="600">

Раскраску по доменам нет смысла пояснять, поговорим об обязательности.
...
<img src="imgs/ticktick-task-priority.png" width="150">
...
<img src="imgs/ticktick-calendar-work.png" width="600">
